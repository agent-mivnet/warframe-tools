...
const DEFAULT_FRAME_OWNED = {
  ash: true, banshee: true, baruuk: true, baruuk_prime: true,
  chroma: true, dante: true, ember: true, excalibur: true,
  excalibur_umbra: true, frost: true, frost_prime: true, grendel: true,
  hildryn: true, hydroid: true, hydroid_prime: true, jade: true,
  khora: true, khora_prime: true, lavos: true, limbo: true,
  loki_prime: true, mirage: true, nekros: true, nezha: true,
  nidus: true, nova: true, nyx: true, nyx_prime: true,
  oberon: true, octavia: true, octavia_prime: true, qorvex: true,
  revenant: true, rhino: true, saryn: true, saryn_prime: true,
  titania: true, titania_prime: true, trinity: true, valkyr: true,
  volt: true, voruna_prime: true, wukong: true, yareli: true,
  zephyr: true, banshee_prime: true, caliban: true, caliban_prime: true,
  citrine: true, voidrig: true, elytron: true, itzal: true,
};
